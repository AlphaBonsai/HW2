function display2_1() {
  var myanswer  = " the first one is undefined b/c dragonball was not listed.the second one well output a true b/c == can handal diffrenaces in type.the third one's out put would be false,b/c the === is a strict equality but does not handal type difrences so b/c null and undefined are not of the sam type the output is false.." // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: the 'use strict' is a method that makes it mandetory to declaer a variable befor it is called, like c++. this code will thow an error." // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: IDK" // TODO 2.5: Fill in Answer here
...
function getChildrenTags() { // Do not add or remove lines to this function
  var children = document.getElementsById("div_1134").children; // TODO: Question 2.5 Use the appropriate function to get all the children of a div named 'div_1134'
